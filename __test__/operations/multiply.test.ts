...
describe('multiply operation expression', () => {

  test('should compile multiply operation expression with 2 operands', () => {
  ...
  test('should compile multiply operation expression with multiple operands', () => {
